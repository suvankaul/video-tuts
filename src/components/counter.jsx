    ...
    render() {
        ...
        return (
            <div>
                ...
                <button style={{ 'fontSize': '16px','padding':'5px','margin':'5px' }} className="btn btn-secondary btn-sm" onClick={() => this.props.onAdd(this.props.counter)}>Add</button>
                {/* To pass parameters into function */}
                {/* <button onClick={()=> this.productDetails("product")}>Product</button> */}
                <button style={{ 'fontSize': '16px', 'padding':'5px','margin':'5px'}} className="btn btn-danger btn-sm" onClick={() => this.props.onDelete(this.props.counter.id)}>Delete</button>
                {/* <div>
